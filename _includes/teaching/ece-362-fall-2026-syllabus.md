...
*Per-class (M/W/F) plan. Module tags (M1–M7) reference the slide decks in `slides/`; `Lx` = that module's lecture x. The 50-min period = ~5 min recap + ~35 min material & board work + 10 min pop quiz on the last class of each week. Calendar (dates/holidays/final) matches the official UH Mānoa Fall 2026 grid on the course site.*
...
**Exam dates:** Midterm 1 — Wed **Sep 23**; Midterm 2 — Fri **Oct 30**; Final — Mon **Dec 14, 12:00–2:00 PM**.
