...
| ----------------- | ------------------------------------------------------------------- | --------------------------------------------------- | ------------------------------------------------------ | ---------- | ------------------------------------------------------ |
| 1 · Aug 24–28     | **No class**                                                        | **Course introduction, syllabus, and course tools** | Propositional logic + inference rules (M1·L1–2)        | Ch. 1      | **HW1 assigned 8/28**                                  |
| 2 · Aug 31–Sep 4  | Predicate logic (M1·L3)                                             | Proof techniques (M1·L4)                            | Sets and operations (M2·L1)                            | Ch. 1–2    | **M1 quiz 9/4; HW2 assigned 9/4**                      |
| 3 · Sep 7–11      | **Labor Day — no class**                                            | Set identities and Cartesian products (M2·L1)       | Relations and their properties (M2·L2)                 | Ch. 2, 9   | **HW1 due 9/9**                                        |
| 4 · Sep 14–18     | Functions (M2·L3)                                                   | Floor/ceiling and cardinality (M2·L4–5)             | Equivalence relations (M2·L6)                          | Ch. 2, 9   | —                                                      |
| 5 · Sep 21–25     | Partial orders and Hasse diagrams (M2·L7)                           | **Review M1–M2 + M2 quiz**                          | **★ Midterm 1**                                        | Ch. 1–2, 9 | **HW2 due 9/23; Midterm 1 on 9/25**                    |
...
**No class:** Aug 24 and Aug 26 before the first course meeting; Labor Day (Mon 9/7), Veterans Day (Wed 11/11), Thanksgiving (Thu 11/26–Fri 11/27). *(Verified against the published UH Mānoa Fall 2026 academic calendar; see CALENDAR_AUDIT.md for sources.)*
